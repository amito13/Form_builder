...
export default function FormsPage() {
  ...
  const mostRecentForm = useMemo(
    () =>
      forms.reduce<FormListItem | null>((latest, form) => {
        const latestTime = latest?.updatedAt
          ? new Date(latest.updatedAt).getTime()
          : -Infinity;
        const formTime = form.updatedAt
    ...
    <main className="forms-page">
      <aside className="forms-sidebar" aria-label="Workspace navigation">
        ...
        <div className="forms-user">
          <div className="forms-user-avatar" aria-hidden="true">
            {initial}
          </div>
          <div className="forms-user-copy">
            <strong>{userName}</strong>
            <span>{userQuery.data?.email || "Loading account…"}</span>
          </div>
        </div>
      </aside>
      ...
      <section className="forms-workspace" aria-labelledby="forms-title">
        <header className="forms-hero-section">
          <div className="forms-hero-content">
            ...
            <p className="forms-hero-subtitle">
              ...
              audience better. All in one place.
            </p>
        ...
        <section className="forms-content" aria-labelledby="forms-list-title">
          <div className="forms-content-heading">
            <div>
              <p className="forms-section-label">Workspace</p>
              <h2 id="forms-list-title">Forms</h2>
            </div>
          ...
          {!formsQuery.isPending &&
            !formsQuery.isError &&
            filteredForms.length > 0 && (
              <div id="forms-grid" className="forms-grid">
